    ...
    return (
        <>
            {routes.length > 0 ? (
                <DataTable
                    columns={
                        width > WIDTH_THRESHOLD ? FULL_COLUMNS : SLIM_COLUMNS
                    }
                    data={routes}
                ...
                <Text textAlign="center">
                    No routes were found on your Strava account. Routes marked
                    as private will not be displayed here.
                </Text>
            )}
        </>
    );
